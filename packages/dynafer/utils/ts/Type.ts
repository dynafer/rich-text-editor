...
const isInstance = <T>(instance: IClassConstructor<T>) => (value: unknown): value is T => value instanceof instance;
...
export const IsSameInstance = <T>(value: unknown, instance: IClassConstructor<T>): value is T =>
