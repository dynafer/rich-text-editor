...
const TestStyle = () =>
	describe('@dynafer/dom-control/Style', () => {
		...
		it('should return a dictionary of styles for the given div with GetAsMap()', () => {
			div.style.color = 'red';
		...
		it('should return the cssText of the style property for the given div with GetText()', () => {
			div.style.color = 'red';
			const cssText = Style.GetText(div);
			expect(cssText).toBe('color: red;');
		});

		it('should override an existing style property for the given div with Set()', () => {
			div.style.color = 'red';
		...
		it('should remove multiple style properties for the given div with RemoveMultiple()', () => {
			div.style.color = 'red';
			div.style.backgroundColor = 'blue';
		...
		describe('Has', () => {
			...
			it('should return false if the style property does not exist for the given div', () => expect(Style.Has(div, 'color')).toBe(false));
