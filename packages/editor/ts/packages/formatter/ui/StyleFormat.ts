...
const StyleFormat = (editor: Editor, detector: IFormatDetector): IFormatUIRegistryUnit => {
	...
	const StyleFormats: Record<string, IStyleFormatUI> = {
		Alignment: {
			Items: [
				{ Format: Formats.Justify as IStyleFormat, Title: self.Lang('format.alignJustify', 'Justify'), CommandName: 'Justify', Icon: 'AlignJustify', bDetector: true },
				{ Format: Formats.AlignLeft as IStyleFormat[], Title: self.Lang('format.alignLeft', 'Align left'), CommandName: 'AlignLeft', Icon: 'AlignLeft', bDetector: true },
				{ Format: Formats.AlignCenter as IStyleFormat[], Title: self.Lang('format.alignCenter', 'Align center'), CommandName: 'AlignCenter', Icon: 'AlignCenter', bDetector: true },
				{ Format: Formats.AlignRight as IStyleFormat[], Title: self.Lang('format.alignRight', 'Align right'), CommandName: 'AlignRight', Icon: 'AlignRight', bDetector: true },
			]
		},
		Indentation: {
			...
			Items: [
				{
					...
					Title: self.Lang('format.Outdent', 'Outdent'),
					CommandName: 'Outdent',
					Icon: 'Outdent',
					bDetector: true,
					bSubtract: true,
				...
				{ Format: Formats.Indent as IStyleFormat, Title: self.Lang('format.Indent', 'Indent'), CommandName: 'Indent', Icon: 'Indent', bDetector: false, Keys: 'Tab' },
			]
		}
	};
