...
const Inline = (editor: Editor, detector: IFormatDetector): IFormatUIRegistryUnit => {
	...
	const InlineFormats: Record<string, IInlineFormatUI> = {
		Bold: { Format: Formats.Bold as IInlineFormat[], Title: self.Lang('format.bold', 'Bold'), CommandName: 'Bold', Icon: 'Bold', Keys: 'Ctrl+B' },
		Italic: { Format: Formats.Italic as IInlineFormat[], Title: self.Lang('format.italic', 'Italic'), CommandName: 'Italic', Icon: 'Italic', Keys: 'Ctrl+I' },
		Strikethrough: { Format: Formats.Strikethrough as IInlineFormat[], Title: self.Lang('format.strikethrough', 'Strikethrough'), CommandName: 'Strikethrough', Icon: 'Strikethrough' },
		Subscript: { Format: Formats.Subscript as IInlineFormat, Title: self.Lang('format.subscript', 'Subscript'), CommandName: 'Subscript', Icon: 'Subscript' },
		Superscript: { Format: Formats.Superscript as IInlineFormat, Title: self.Lang('format.superscript', 'Superscript'), CommandName: 'Superscript', Icon: 'Superscript' },
		Underline: { Format: Formats.Underline as IInlineFormat[], Title: self.Lang('format.underline', 'Underline'), CommandName: 'Underline', Icon: 'Underline', Keys: 'Ctrl+U' },
		Code: { Format: Formats.Code as IInlineFormat, Title: self.Lang('format.code', 'Code'), CommandName: 'Code', Icon: 'Code' },
	};
